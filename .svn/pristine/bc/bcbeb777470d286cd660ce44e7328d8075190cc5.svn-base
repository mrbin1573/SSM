...
public class JbPushgrid51 {
    private Integer 序号;

    private String 主动控制变量位号;

    private String 主动控制变量名;
    ...
    public String get主动控制变量位号() {
        return 主动控制变量位号;
    }

    public void set主动控制变量位号(String 主动控制变量位号) {
        this.主动控制变量位号 = 主动控制变量位号 == null ? null : 主动控制变量位号.trim();
    }

    public String get主动控制变量名() {
        return 主动控制变量名;
    }

    public void set主动控制变量名(String 主动控制变量名) {
        this.主动控制变量名 = 主动控制变量名 == null ? null : 主动控制变量名.trim();
    }
