                                    ...
                                    <form id="uploadForm">
	                                    <div class="upload">
	                                        <a href="javascript:;" class="file">选择 excel 文件
	                                                <input type="file" name="jy_file" id="file"  onchange="fileList()" accept="application/vnd.ms-excel" multiple>
...
<script>
   ...
   // }${pageContext.request.contextPath}/doAjaxUpload.action"
        ...
        function UpladFile() {
            ...
            var url = "${pageContext.request.contextPath}/jy_doUploadFile.action"; // 接收上传文件的后台地址 
        ...
        function tohref(){
        	window.location.href ="jy_toUploadType.action";
        }
        //上传失败
