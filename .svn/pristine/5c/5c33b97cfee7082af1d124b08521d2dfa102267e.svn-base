                ...
                <div class="tab-content menu-third-content navbar-fixed-top">
                    <div class="tab-pane fade in active" id="three_1">
                        ...
                        <ul id="myTab" class="nav nav-tabs menu_rihgt_after">
                            <li class="active">
                                <a href="#three_c_1" data-toggle="tab"><img src="images/menu_third.png">&nbsp;&nbsp;广安玖源原始数据上传</a>
                            </li>
                        </ul>
                        </div>
                </div>
                                    ...
                                    <form id="uploadForm">
	                                    <div class="upload">
	                                        <a href="javascript:;" class="file">选择 excel 文件
	                                                <input type="file" name="gajy_file" id="file"  onchange="fileList()" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" multiple>
...
<script>
   ...
   // }${pageContext.request.contextPath}/doAjaxUpload.action"
        ...
        function UpladFile() {
            ...
            var url = "${pageContext.request.contextPath}/gajy_doUploadFile.action"; // 接收上传文件的后台地址 
        ...
        function tohref(){
        	window.location.href ="gajy_toUploadType.action";
        }
        //上传失败
