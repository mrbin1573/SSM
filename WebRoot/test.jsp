        ...
        <table class="table table-striped table-bordered table-hover table-condensed " id="testInfo">
			...
			<tr>
			 ...
			 <tr>
                ...
                <td class="text-center">男</td>
                <td class="text-center">1234568799</td>
				 <td class="text-center">小丰东股份的办法能够</td>
...
<script src="tableExport/js/table.js"></script>
<script src="tableExport/tableExport/libs/pdfMake/pdfmake.min.js"></script>
<script src="tableExport/tableExport/libs/pdfMake/vfs_fonts.js"></script>
...
<script type="text/javascript" src="tableExport/tableExport/tableExport.js"></script>
<script src="tableExport/js/table-export.js"></script>
