		...
		<div class="tab-pane fade in active" id="second_1">
			...
			<center>
				<div><br>
					...
					<table class="table" border="1px">
						<tr>
							...
							<div class="button_box">
								...
								<button id="addcol">增加一个关联变量</button>
							</div>
					...
					<span style="float:left;margin-left:7%; text-align: left;"><h5>注：① 实施调控关联变量指此次指令所发布的动态调控被动控制变量实际调控时调控的关联变量，请根据具体实施情况填表。
					<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;② 关联变量的填写可以通过点击表格右边的小三角进行下拉选择，也可以点击表格内手动输入。
					</h5></span>
...
<script>
	...
	$("#backtable_sb").on("click",function(){
		var url = "${pageContext.request.contextPath}/jf_doUserVar.action";
		var datas = [];
		var data1 = "123123";
