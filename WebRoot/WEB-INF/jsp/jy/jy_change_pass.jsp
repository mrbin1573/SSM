	...
	<div class="tab-content">
		...
		<div class="tab-pane fade in active" id="second_1">
			...
			<div class="tab-content"><br>
				<!-----------------------上传------------------>
				<form action="jy_doUpIfo.action" method="post">
					<div>
						<!-- 原始密码 -->
						<div class="zl_line">
							<div class="zl_title">
							...
							<div class="zl_input">
								<input class="old_input" type="password"oninput="ck_old()"required>
						...
						<div class="zl_line">
							...
							<div class="zl_input">
								<input type="password"class="new_pass"oninput="ch_new_old()"required >
						...
						<div class="zl_line">
							...
							<div class="zl_input">
								<input type="password" required class="ck_new_pass"oninput="ck_pass()">
						...
						<div class="zl_line">
							...
							<div class="zl_input">
								<input oninput="ck_yzm()" class="login_yzm"placeholder="不区分大小写" >
...
<script>
	...
	/******************判断验证码是否正确 *******************/
    function ck_yzm(){
    	var yzm = $(".yzm input").val().trim().toUpperCase()//原始验证码
   ...
   /************检验  新密码是否一致 ***************/
    function ck_pass(){
		...
		if(ckPass.length >= newPass.length){
			if(newPass != ckPass){
